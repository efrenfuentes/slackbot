defmodule Slackbot.Utils do
  @moduledoc """
  Module consisting of all the convenience functions for `Slackbot` to operate
  """
  ...
  @doc false
  def useragent, do: {"User-Agent", "Slackbot"}
  ...
  defp pid, do: :global.whereis_name("slackbot")
end
